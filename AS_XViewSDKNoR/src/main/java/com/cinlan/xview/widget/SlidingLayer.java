...
public class SlidingLayer extends FrameLayout {
	...
	private static final int MAX_SCROLLING_DURATION = 0; // in ms
	...
	public SlidingLayer(Context context, AttributeSet attrs, int defStyle) {
		...
		final TypedArray ta = context.obtainStyledAttributes(attrs,
				R.styleable.SlidingLayer_xviewsdk);

		// Set the side of the screen
		setStickTo(ta.getInt(R.styleable.SlidingLayer_xviewsdk_stickTo, STICK_TO_RIGHT));
