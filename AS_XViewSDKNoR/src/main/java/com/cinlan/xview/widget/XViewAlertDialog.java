...
public class XViewAlertDialog {
	...
	public XViewAlertDialog(Context context) {
	...
	public XViewAlertDialog builder() {
	...
	public XViewAlertDialog setTitle(String title) {
		showTitle = true;
		if ("".equals(title)) {
			txt_title.setText("");
		} else {
	...
	public XViewAlertDialog setMsg(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("");
		} else {
	...
	public XViewAlertDialog setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public XViewAlertDialog setPositiveButton(String text,
	...
	public XViewAlertDialog setNegativeButton(String text,
                                              final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
